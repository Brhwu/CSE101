...
// LeftRotate()
void Dictionary::LeftRotate(Node* N) {   // based on RBT pseudocode LeftRotate
   Node* Y = N->right;
...
// RightRotate()
void Dictionary::RightRotate(Node* N) {   // based on RBT pseudocode RightRotate
   Node* Y = N->left;
...
// RB_InsertFixUP()
void Dictionary::RB_InsertFixUp(Node* N) {    // based on RBT pseudocode RB_InsertFixUp
...
// RB_Transplant()
void Dictionary::RB_Transplant(Node* u, Node* v) {   // based on RBT pseudocode RB_Transplant
   if(u->parent == nil) {
      root = v; 
   }
...
// RB_DeleteFixUp()
void Dictionary::RB_DeleteFixUp(Node* N) {   // based on RBT pseudocode RB_DeleteFixUp
...
// RB_Delete()
void Dictionary::RB_Delete(Node* N) {   // based on RBT pseudocode RB_Delete
   Node* Y = N;  
   Node* X = nil;
...
void Dictionary::setValue(keyType k, valType v) {  // based on textbook pseudocode RB_Insert
   Node* Z = new Node(k, v);  
   Z->right = nil;
   Z->left = nil;
   Z->parent = nil;
