...
int main(){
   ...
   A.insertBefore(1);
   cout << "A = " << A << endl;
   cout << "1A.position() = " << A.position() << endl;
   cout << "peekPrev: " << A.peekPrev() << endl; 
   A.insertBefore(2);
   cout << "A = " << A << endl;
    cout << "2A.position() = " << A.position() << endl;
    cout << "peekPrev: " << A.peekPrev() << endl;
    A.insertBefore(2);
    cout << "3A = " << A << endl;
   ...
   cout << "peekPrev: " << C.peekPrev() << endl;
   cout << "D = " << D << endl;
   cout << "D.position() = " << D.position() << endl;
   cout << "peekPrev: " << D.peekPrev() << endl;
   cout << endl;
   ...
   cout << endl;
   cout << "A==B is " << (A.equals(B)?"true":"false") << endl;
   cout << "A==B is " << (A==B?"true":"false") << endl;
   cout << "B==C is " << (B.equals(C)?"true":"false") << endl;
