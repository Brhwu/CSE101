...
Node newNode(void* data) { //based on newNode from queue.c
...
// Pre: length()>0  
void* front(List L) {  //based on getFront from queue.c
   if(L==NULL) {
...
// Pre: length()>0
void* back(List L) { //based on getFront from queue.c
   if(L==NULL) {
...
void* get(List L){ //based on getFront from queue.c
   if(L==NULL){
...
void prepend(List L, void* x) { //based on Enqueue from queue.c
   Node N = newNode(x);
   if(L==NULL) {
...
void append(List L, void* x) { //based on Enqueue from queue.c
   Node N = newNode(x);
   if(L==NULL) {
